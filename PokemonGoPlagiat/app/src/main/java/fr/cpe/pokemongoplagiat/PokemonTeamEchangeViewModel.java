...
public class PokemonTeamEchangeViewModel extends BaseObservable {
    ...
    OnClickOnEchangerPokemonListener listenerEchangerPokemon;
    public void setOnClickOnEchangerPokemonListener(OnClickOnEchangerPokemonListener listener)
    {
        this.listenerEchangerPokemon = listener;
    }
